...
public class primer_principal {
    ...
    public primer_principal(primer_principal partido) {
    ...
    public primer_principal(ArrayList<Equipo> equiposVisitante, ArrayList<Equipo> equiposLocal, ArrayList<Arbitro> arbitros, int golesVisitante, int golesLocal, Date fecha) {
